            ...
            <div className="flex p-8 gap-8">
              ...
              <div>
                ...
                <div className="text-black mt-6">
                  {activeTab === "login" ? (
                    <>
                      <input type="email" placeholder={translations.email} className="w-full px-4 py-4 rounded-lg mb-3 bg-gray-100 focus:outline-none" />
                      <input type="password" placeholder={translations.password} className="w-full px-4 py-4 rounded-lg mb-3 bg-gray-100 focus:outline-none" />
                    ...
                    <>
                      <input type="text" placeholder={translations.lastName} className="w-full px-4 py-4 rounded-lg mb-3 bg-gray-100 focus:outline-none" />
                      <input type="text" placeholder={translations.firstName} className="w-full px-4 py-4 rounded-lg mb-3 bg-gray-100 focus:outline-none" />
                      <input type="email" placeholder={translations.email} className="w-full px-4 py-4 rounded-lg mb-3 bg-gray-100 focus:outline-none" />
                      <input type="password" placeholder={translations.password} className="w-full px-4 py-4 rounded-lg mb-3 bg-gray-100 focus:outline-none" />
                      <input type="password" placeholder={translations.confirmPassword} className="w-full px-4 py-4 rounded-lg mb-3 bg-gray-100 focus:outline-none" />
